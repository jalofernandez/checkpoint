  ...
  data() {
    return {
      projects: [
        {
          name: 'Canessa',
          url: 'canessa/customers',
          web: 'peluqueriacanessa.com',
          version: '2.0.7',
        },
        {
          name: '@Jalofernandez',
          url: 'jalofernandez/portfolio',
          web: 'jalofernandez.com',
          version: '2.0.5',
        },
        {
          name: '#HazTuNegocioDigital',
          url: 'haztunegociodigital/negocios',
          web: 'haztunegociodigital.com',
          version: '1.1.12',
        },
      ]
    }
